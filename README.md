...
Shopping behavior (discounts, ratings, shipping type)
...
Answered business questions using SQL (revenue trends, customer segments, product performance)
...
Loyal customers contribute a large share of revenue
